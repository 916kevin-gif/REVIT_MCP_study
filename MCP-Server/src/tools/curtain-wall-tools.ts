    ...
    },
    {
        ...
        inputSchema: {
            ...
            properties: {
                ...
                addDimensions: { type: "boolean", description: "是否加入總寬、總高與水平／垂直帷幕網格尺寸，預設 true。", default: true },
    ...
    },
    {
        ...
        inputSchema: {
            ...
            properties: {
                ...
                wallId: { type: "number", description: "帷幕牆 ElementId；未提供時使用第一道可用帷幕牆。" },
                ...
                testMode: { type: "string", enum: ["geometry_reference", "reference_plane_fallback", "both"], description: "要測試的參考策略，預設 both。", default: "both" },
