...
export const doorWindowLegendTools: Tool[] = [
    {
        ...
        inputSchema: {
            ...
            properties: {
                ...
                mode: {
                    type: "string",
                    enum: ["list", "create", "update", "migrate", "diagnose_grouping"],
                ...
                diagnosticAction: {
                    ...
                    default: "run",
                    description:
                        "diagnose_grouping only. run creates isolated cases; finalize checks the next ExternalEvent and removes all diagnostic views.",
                },
                diagnosticToken: {
                    type: "string",
                    description: "diagnose_grouping finalize only. Token returned by the run action.",
                },
            },
            required: ["mode"],
        },
