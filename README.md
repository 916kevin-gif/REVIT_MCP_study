...
Talk to Revit in plain language. Ask your AI client to *"dimension every wall on this view"* or *"check the curtain-wall elevations"*, and Revit does it — through **167 MCP tools** backed by **72 professional BIM SOPs** (building code, quantity take-off, compliance checks).
